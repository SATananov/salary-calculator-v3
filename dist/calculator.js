...
export function calculateBruto(salary, globalTurnover, personalTurnover, coefGeneral, coefPersonal) {
...
export function calculateForDealer(dealer, monthlyData, globalTurnover, month, year, locations) {
    const bruto = calculateBruto(monthlyData.salary, globalTurnover, monthlyData.personalTurnover, dealer.coefGeneral, dealer.coefPersonal);
...
export function calculateForAllDealers(dealers, monthlyDataMap, globalTurnover, month, year, locations) {
    const results = [];
